...
function Signup() {
    ...
    <label htmlFor="Login" className="text-2xl font-bold flex justify-center align-center text-black mx-4 my-4">Create Account</label>
   <br />

   <div className="flex mx-4 my-8">

      <label htmlFor="email" className="block text-sm font-medium text-gray mx-4">Email:</label>
    <input type="email" id="email" name="email" placeholder="Enter your email"   className="border border-gray rounded-md px-3 py-2 mx-8 " required />
     
   </div>
   <div className="flex mx-4 my-8">
     <label htmlFor="password" className="block text-sm font-medium text-gray  mx-1">Password:</label>
    <input type="password" id="password" name="password" placeholder="Enter your password"   className="border border-gray rounded-md px-3 py-2 mx-8 " required />
 ...
 <div className="flex justify-center items-center mx-auto my-16 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-44 rounded">
   ...
   <div>
    <p> Already a existing user <Link to="/" className="text-blue-500 hover:underline">login</Link></p>
   </div>
